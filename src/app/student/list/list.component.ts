...
export class StudentDataSource extends DataSource<Student> {
  ...
  connect(): Observable<Student[]> {
        ...
        this.filteredData = this._studentDatabase.data.slice().filter((student: Student) => {
          ...
          const searchStr = (student.nombre + student.apellido + student.idTipoNivelEstudio).toLowerCase();
        ...
        return Observable.merge(...displayDataChanges).map(() => {
          ...
          this.filteredData = this._studentDatabase.data.slice().filter((student: Student) => {
            ...
            if(student === undefined || student.id === undefined){
              ...
              this.searchStr = (student.nombre + student.apellido + student.idTipoNivelEstudio).toLowerCase();
            }            
    ...
    sortData(data: Student[]): Student[] {
        ...
        return data.sort((a, b) => {
          ...
          switch (this._sort.active) {
            ...
            case 'firstName': [propertyA, propertyB] = [a.nombre, b.nombre]; break;
            case 'lastName': [propertyA, propertyB] = [a.apellido, b.apellido]; break;
            case 'typeGrade': [propertyA, propertyB] = [a.idTipoNivelEstudio, b.idTipoNivelEstudio]; break;
            case 'studentCode': [propertyA, propertyB] = [a.codigo, b.codigo]; break;
